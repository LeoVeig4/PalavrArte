<template>
  ...
  <aside
    ...
    :class="`${
      this.$store.state.isRTL ? ' rotate-caret fixed-end' : 'fixed-start '
    } 
    ${
  ...
  >
    <div class="sidenav-header">
      ...
      <router-link class="m-0 navbar-brand" to="/">
        ...
        <span class="ms-2 font-weight-bold me-2">SmartNutri</span>
      </router-link>
    </div>
...
import logo from "@/assets/img/logo-smart.png";
export default {
  name: "index",
  components: {
    SidenavList,
