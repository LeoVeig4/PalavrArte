            ...
            <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                <div class="card z-index-0 shadow-lg">
                    ...
                    <div class="card-body text-start mt-n5">
                        ...
                        <p><span class="fw-bold">nota:</span> {{ texto.nota }}</p>
                        <p><span class="fw-bold">Autor: </span>{{ texto.inscricao.nome }}</p>
                        <p><span class="fw-bold">Categoria: </span><span class="badge badge-pill ms-1"
                                :class="badge[index % 6]">{{ texto.categoria }}
                            </span></p>
                        <div class="text-center">
                            <router-link v-if="!Avaliar" :to="`/texto/${texto.id}`"
                                class="btn bg-gradient-primary  w-100 mt-4 mb-0">Ler
                                Texto</router-link>
                            <router-link v-else :to="`avaliar/texto/${texto.id}`"
